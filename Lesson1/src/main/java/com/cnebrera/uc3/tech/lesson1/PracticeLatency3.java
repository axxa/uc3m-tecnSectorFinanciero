...
{
    static Histogram histogram = new Histogram(3600000000000L, 2);
    ...
    private static void runCalculations()
    {
        ...
        for (int i = 0; i < NUM_THREADS; i ++)
        {
            ...
            final Runner runner = new Runner(syncOpSimulator, histogram);
            runners.add(runner);
    ...
    private static class Runner implements Runnable
    {
         ...
         */
        private Runner(BaseSyncOpSimulator syncOpSimulator, Histogram histogram)
        {
