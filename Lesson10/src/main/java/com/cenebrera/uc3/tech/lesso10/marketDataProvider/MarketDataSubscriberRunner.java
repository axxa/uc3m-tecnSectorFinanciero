...
public class MarketDataSubscriberRunner {
    ...
    public static void main(String[] args) {
        ...
        //Create message
        MarketDataRequest message = createMarketMessage();
    ...
    private static MarketDataRequest createMarketMessage() {
        MarketDataRequest marketDataRequest = new MarketDataRequest();
        marketDataRequest.set(new MDReqID("Test 1"));
    ...
    private static void sendMarketMessage(MarketDataRequest message) {
        try {
            Session.sendToTarget(message, "Initiator", "Acceptor");
